angular.module('app.menu', [ 'ionic-modal-select' ])
  ...
  .controller('menuCtrl', [ '$scope', 'ProfileFactory', '$location', '$ionicPopup', '$ionicSideMenuDelegate', 'SISOSprints', '$cordovaDialogs', '$window', '$ionicPlatform',
    function ($scope, ProfileFactory, $location, $ionicPopup, $ionicSideMenuDelegate, SISOSprints, $cordovaDialogs, $window, $ionicPlatform) {
