angular.module("app.geofences", [])


  .controller("GeofencesCtrl", function ($scope,
                                         $ionicActionSheet,
                                         $timeout,
                                         $log,
                                         $state,
    ...
    $scope.$on('$ionicView.beforeEnter', function () {
      ...
      $log.log('Entering to GeofencesCtrl');
