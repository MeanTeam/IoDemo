(function () {
  ...
  angular.module('app.leaflet-directive').directive('center', [
    '$log',
    '$q',
    '$location',
    'leafletMapDefaults',
  ...
  angular.module('app.leaflet-directive').directive('tiles', [
    '$log',
    'leafletData',
    'leafletMapDefaults',
    'leafletHelpers',
  ...
  angular.module('app.leaflet-directive').directive('legend', [
    '$log',
    '$http',
    'leafletHelpers',
  ...
  angular.module('app.leaflet-directive').directive('geojson', [
    '$log',
    '$rootScope',
    'leafletData',
    'leafletHelpers',
  ...
  angular.module('app.leaflet-directive').directive('layers', [
    '$log',
    '$q',
    'leafletData',
    'leafletHelpers',
  ...
  angular.module('app.leaflet-directive').directive('bounds', [
    '$log',
    '$timeout',
    'leafletHelpers',
    'leafletBoundsHelpers',
  ...
  angular.module('app.leaflet-directive').directive('markers', [
    '$log',
    '$rootScope',
    '$q',
    'leafletData',
  ...
  angular.module('app.leaflet-directive').directive('paths', [
    '$log',
    'leafletData',
    'leafletMapDefaults',
    'leafletHelpers',
  ...
  angular.module('app.leaflet-directive').directive('controls', [
    '$log',
    'leafletHelpers',
  ...
  angular.module('app.leaflet-directive').directive('eventBroadcast', [
    '$log',
    '$rootScope',
    'leafletHelpers',
    'leafletEvents',
  ...
  angular.module('app.leaflet-directive').directive('maxbounds', [
    '$log',
    'leafletMapDefaults',
    'leafletBoundsHelpers',
  ...
  angular.module('app.leaflet-directive').service('leafletData', [
    '$log',
    '$q',
    'leafletHelpers',
  ...
  angular.module('app.leaflet-directive').factory('leafletMapDefaults', [
    '$q',
    'leafletHelpers',
  ...
  angular.module('app.leaflet-directive').factory('leafletEvents', [
    '$rootScope',
    '$q',
    '$log',
    'leafletHelpers',
  ...
  angular.module('app.leaflet-directive').factory('leafletLayerHelpers', [
    '$rootScope',
    '$log',
    'leafletHelpers',
  ...
  angular.module('app.leaflet-directive').factory('leafletControlHelpers', [
    '$rootScope',
    '$log',
    'leafletHelpers',
    'leafletMapDefaults',
  ...
  angular.module('app.leaflet-directive').factory('leafletLegendHelpers', function () {
  ...
  angular.module('app.leaflet-directive').factory('leafletPathsHelpers', [
    '$rootScope',
    '$log',
    'leafletHelpers',
    function ($rootScope, $log, leafletHelpers) {
  ...
  angular.module('app.leaflet-directive').factory('leafletBoundsHelpers', [
    '$log',
    'leafletHelpers',
    function ($log, leafletHelpers) {
  ...
  angular.module('app.leaflet-directive').factory('leafletMarkersHelpers', [
    '$rootScope',
    'leafletHelpers',
    '$log',
  ...
  angular.module('app.leaflet-directive').factory('leafletHelpers', [
    '$q',
    '$log',
    function ($q, $log) {
